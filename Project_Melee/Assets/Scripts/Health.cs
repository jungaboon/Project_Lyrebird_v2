...
public class Health : MonoBehaviour, IDamage
{
    ...
    public virtual void Damage(Vector3 attackDirection, float attackDamage = 1, DamagePoint damagePoint = DamagePoint.High, bool knockback = false, Vector3 knockbackDirection = default)
    {
